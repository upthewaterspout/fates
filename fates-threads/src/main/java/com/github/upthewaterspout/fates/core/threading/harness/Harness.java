...
public class Harness {
  ...
  public static void runTest(List<Class<?>> atomicClasses, Fates fates,
   ...
   */
  private static RepeatedTest instrumentTest(List<String> atomicClasses,
   ...
   */
  public static ExecutionEventListener createExecutionEventPipeline(List<String> atomicClasses,
                                                                    Decider decider) {
